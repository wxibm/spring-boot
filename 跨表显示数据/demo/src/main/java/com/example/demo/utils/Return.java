...
public class Return {
    ...
    public static <T> ReturnT<T> Login() {
        return new ReturnT<T>().setCode(ReturnCode.LOGIN.getCode()).setMsg(ReturnCode.LOGIN.getMsg());
    }

    public static <T> ReturnT<T> Login(T data) {
        return new ReturnT<T>().setCode(ReturnCode.LOGIN.getCode()).setMsg(ReturnCode.LOGIN.getMsg()).setData(data);
    }
}
